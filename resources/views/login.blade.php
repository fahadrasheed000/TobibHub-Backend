...
<head>
    ...
    <title>TobibHub Login</title>
</head>
<body class="background-image-for-front-side controller__users action__b2c_login wopiz-background font-clr"
...
<main>
    <div class="page-wrap">
                                                    ...
                                                    <ul class="main-drop">
                                                        <li>
                                                            ...
                                                            <ul class="desk-multi-level">
                                                                <li>
                                                                    <a href="#">
                                                                        Dermatologist in Malacca
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="#">
                                                                        Dermatologist in Putrajaya
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="#">
                                                                        Dermatologist in Kuala Lumpur
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    ...
                                                    <ul class="main-drop">
                                                        <li>
                                                            ...
                                                            <ul class="desk-multi-level">
                                                                <li>
                                                                    <a href="#">
                                                                        Cardiologist in Malacca
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="#">
                                                                        Cardiologist in Putrajaya
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="#">
                                                                        Cardiologist in Kuala Lumpur
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    ...
                                                    <ul class="main-drop">
                                                        <li>
                                                            ...
                                                            <ul class="desk-multi-level">
                                                                <li>
                                                                    <a href="#">
                                                                        Hyperthyroidism in Malacca
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="#">
                                                                        Hyperthyroidism in Putrajaya
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="#">
                                                                        Hyperthyroidism in Kuala Lumpur
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul class="desk-multi-level">
                                                                <li>
                                                                    <a
                                                                        href="#">
                                                                        High Blood Pressure in Malacca
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="#">
                                                                        High Blood Pressure in Putrajaya
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="#">
                                                                        High Blood Pressure in Kuala Lumpur
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                    ...
                                    <div class="drop-down-wrapper">
                                        <div class="drop-down-inner container">
                                            <div class="row">
                                                <div class="col-3">
                                                    <div class="drop-right-header">
                                                        <div class="menu-heading">Hospitals of Malacca</div>
                                                    </div>
                                                    <ul class="main-drop">
                                                        <li>
                                                            <a href="#">
                                                ...
                                                <div class="col-3">
                                                    <div class="drop-right-header">
                                                        <div class="menu-heading">Hospitals of Putrajaya</div>
                                                    </div>
                                                    <ul class="main-drop">
                                                        <li>
                                                            <a
                                                ...
                                                <div class="col-3">
                                                    <div class="drop-right-header">
                                                        <div class="menu-heading">Hospitals of Kuala Lumpur</div>
                                                    </div>
                                                    <ul class="main-drop">
                                                        <li>
                                                            <a
                                                ...
                                                <div class="col-3">
                                                    <div class="drop-right-header">
                                                        <div class="menu-heading">Hospitals in Malaysia</div>
                                                    </div>
                                                    <ul class="main-drop">
                                                        <li>
                                                            <a href="#">
        ...
        <div class="menu-slide-wrap">
            ...
            <div class="menu-blocks profile-block">
                ...
                <div class="logout-area">
                    <a class="logout" onclick="window.location.href='{{route('home')}}'">Log out</a>
                ...
                <div class="signup-wrapper">
                    <div class="inner-wrapper">
                        <div class="content">
                            ...
                            <form class="form-horizontal" id="login_form" action="/b2c/users/send_one_time_otp"
                                ...
                                <input type="hidden" name="authenticity_token" id="authenticity_token"
                                       value="KYS6i+l6O+YKqVcoP6R8OgIjNEMmaUumPu7bcrTLoJulnw3apYM4+wCfy+TN/TrAg8JLDjShdiTL7gO7HbBN7g==">
                                <div class="form">
                                    ...
                                    <div class="btn-area">
                                        <input type="submit" name="commit" value="Continue"
                                               class="btn br-5 btn-primary btn-fill pull-right" id="submit_btn_login"
                                               data-disable-with="Please wait..." data-type="button">
                                        <a>Don’t have an account?</a>
                                        <a href="{{route('sign-up')}}"><b>Sign up</b></a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="img-section">
                            <figure>
                                <img src="{{asset('assets/imgs/signup-img-two.webp')}}" alt="signup image" width="253"
                                     height="263">
                            </figure>
                        </div>
                    </div>
        ...
        <a class="event-call-helpline contact_info" href="tel:042 32500989" onclick="gtag_adword_conversion('');">
                ...
                <div class="container">
                    <div class="footer-dark-top">
                        <div class="footer-about">
                                <span class="footer-logo">
                                    ...
                                    <span class="slogan">Your Health is our<span>Priority</span></span>
                                </span>
                            <div class="footer-app-area">
                                <h5>Get The TobibHub App</h5>
                                <ul>
                                    <li><a href="#"
                                           target="_blank">
                        ...
                        <div class="footer-links">
                            ...
                            <div class="footer-cols footer-col-contact">
                                <h6>Contact</h6>
                                <div class="tel"><span> Talk to support </span> <a href="tel:060123456789">060
                                        123456789</a></div>
                    ...
                    <div class="footer-dark-bot">
                        <div class="footer-copyright">
                            <ul>
                                <li>© TobibHub 2023</li>
                                <li><a class="show-loader" href="#">Terms</a></li>
                                <li><a class="show-loader" href="#">Privacy</a></li>
                            </ul>
                        </div>
...
<script src="{{asset('assets/js/jquery_gem_dependency.min.js')}}" defer="defer"></script>
<script>
