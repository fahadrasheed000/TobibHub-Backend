...
<head>
    ...
    <title>Connecting Healthcare</title>
</head>
            ...
            <header class="main-header">
                <div class="container">
                    <div class="header-inner">
                        <div class="logo">
                            <a href="{{route('home')}}">
                                <svg width="166" height="42" class="svg-header-logo show-loader"
                                    viewBox="0 0 166 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <use xlink:href="#header-logo"></use>
                                </svg>
                            </a>
                        </div>
                        <div class="cart-area-mobile mobile">
                            <div class="cart-area-wrap">
                                <div class="cart-block" id="cart-block-mobile">
                                    <a onclick="window.location.href = 'pharmacy7082.html'">
                                        <svg width="25" height="25" class="svg-header-cart show-loader"
                                            viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <use xlink:href="#header-cart"></use>
                                        </svg>
                                    </a>
                                    <span id="cart-notification-mobile" class="cart-notification hide"></span>
                                </div>
                            </div>
                        </div>
                        <div class="search-header show-modal-mobile mobile">
                            <svg width="27" height="28" viewBox="0 0 27 28" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M25.5936 23.1036L20.6754 18.1854C22.1729 15.9437 22.783 13.2252 22.3872 10.5586C21.9913 7.89193 20.6177 5.46789 18.5335 3.75795C16.4494 2.048 13.8037 1.17442 11.1111 1.30712C8.41851 1.43982 5.87155 2.56932 3.96563 4.47591C2.05971 6.38251 0.931113 8.92987 0.799363 11.6225C0.667612 14.3151 1.54213 16.9605 3.25281 19.0441C4.9635 21.1276 7.38802 22.5004 10.0548 22.8953C12.7216 23.2902 15.4399 22.6791 17.681 21.1808L22.5992 26.098C22.9997 26.4886 23.537 26.7072 24.0964 26.7072C24.6558 26.7072 25.1931 26.4886 25.5936 26.098C25.9906 25.7008 26.2136 25.1623 26.2136 24.6008C26.2136 24.0393 25.9906 23.5007 25.5936 23.1036ZM11.6553 4.48322C13.1735 4.48322 14.6577 4.93343 15.9201 5.77693C17.1825 6.62043 18.1664 7.81933 18.7474 9.22201C19.3284 10.6247 19.4804 12.1682 19.1842 13.6573C18.888 15.1463 18.1569 16.5142 17.0833 17.5877C16.0098 18.6613 14.642 19.3924 13.1529 19.6886C11.6638 19.9848 10.1203 19.8328 8.71764 19.2518C7.31495 18.6708 6.11605 17.6868 5.27256 16.4245C4.42906 15.1621 3.97884 13.6779 3.97884 12.1597C3.98108 10.1244 4.79057 8.1732 6.2297 6.73407C7.66882 5.29495 9.62005 4.48546 11.6553 4.48322Z"
                                    fill="#1E4275" stroke="white" stroke-width="0.84711" />
                            </svg>
                        </div>
                        <div class="header-right-area desktop">
                            <nav>
                                <ul>
                                    <li class="menuu"><a>Doctors <span class="arrow down"></span></a>
                                    ...
                                    <li class="menuu"><a href=#>Pharmacy</a></li>
                                    <li class="menuu"><a>Hospitals <span class="arrow down"></span></a>
                                        <div class="drop-down-wrapper">
                                            <div class="drop-down-inner container">
                                                <div class="row">
                                                    <div class="col-3">
                                    ...
                                    <li class="menuu"><a>Lab Tests <span class="arrow down"></span></a>
                                        <div class="drop-down-wrapper">
                                            <div class="drop-down-inner container">
                                                <div class="row">
                                                    <div class="col-3">
                                                ...
                                                <div class="row show-all-cities">
                                                    <div class="col-3">
                                                        <a href="#">All Lab Tests</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="menuu"><a href="#">Company</a></li>
                                    <li class="menuu"><a href="#">Blog</a></li>
                                </ul>
                            </nav>
                            <div class="cart-area-desktop desktop">
                                <div class="cart-area-wrap">
                                    <div class="cart-block" id="cart-block-desktop">
                                        <a onclick="window.location.href= 'pharmacy7082.html'">
                                            <svg width="25" height="25" class="svg-header-cart"
                                                viewBox="0 0 25 25" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <use xlink:href="#header-cart"></use>
                                            </svg>
                                        </a>
                                        <span id="cart-notification" class="cart-notification hide"></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mobile-dropdown mobile">
                            <span class="mobile-icon">
                                <svg class="header-mobile-menu-icon" width="24" height="22"
                                    viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <use xlink:href="#header-mobile-menu-icon"></use>
                                </svg>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="header-search-animation desktop">
                    <div class="container">
                                ...
                                <div class="search-city">
                                    <span class="city-name_header show-modal-mobile" id="search_cities_header">
                                        <input name="city_name_header" id="city_name_header"
                                            ...
                                            onchange="focusSearchBar()" type="text" placeholder="City"
                                            value="">
                                ...
                                <div class="search-main show-modal-mobile">
                                    ...
                                    <div class="input-area">
                                        <input type="text" name="doctor_name_header" id="search_doctors_header"
                                            class="search_doctors_header search_bar_doc_header typeahead tt-query tt-input event-speciality-selection-doctor-search"
            ...
            <div class="menu-slide-wrap">
                ...
                <div class="menu-blocks">
                    ...
                    <div class="guest-area">
                        ...
                        <p>You are using account as guest user. To place an order, you need to Login or Signup to
                            continue</p>
                    </div>
                    ...
                    <div class="menu-links">
                        <ul>
                            <li>
                                <a onclick="window.location.href ='specialities.html'">
                            ...
                            <li>
                                <a onclick="window.location.href ='hospitals/lahore.html'">
                                    <span class="menu-icon-wrap">
                            ...
                            <li>
                                <a onclick="window.location.href ='lab-tests.html'">
                                    <span class="menu-icon-wrap">
                            ...
                            <li>
                                <a onclick="window.location.href = 'pharmacy.html'">
                                    <span class="menu-icon-wrap">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li>
                                <a onclick='window.location.href = "healthcare/index.html"'>
                                    <span class="menu-icon-wrap">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-blocks profile-block">
                    <div class="menu-hd">
                    ...
                    <div class="user-info-area">
                        <figure class="profile-img-wrap">
                            <span class="place-holder"></span>
                            <img class="profile-img hide" src="assets/b2c_design/common/profile_image.svg"
                    ...
                    <div class="menu-links-block">
                        <span class="sub-heading">Account Settings</span>
                        <div class="menu-links">
                            <ul>
                                <li>
                                    <a class="show-loader" href="#">
                                        ...
                                        <span class="menu-txt "> My Account</span>
                                        <span class="arrow right menu-arrow"></span>
                                    </a>
                                </li>
                                <li>
                                    <a class="show-loader" href="#">
                                        <span class="menu-icon-wrap">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <use xlink:href="#saved-address"></use>
                                            </svg>
                                        </span>
                                        <span class="menu-txt">Saved Addresses</span>
                                        <span class="arrow right menu-arrow"></span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="menu-links-block">
                        <span class="sub-heading">Your Activity</span>
                        <div class="menu-links">
                            <ul>
                                <li>
                                    <a href="#">
                                        <span class="menu-icon-wrap">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <use xlink:href="#my-appointments"></use>
                                            </svg>
                                        </span>
                                        <span class="menu-txt"> My Appointments</span>
                                        <span class="arrow right menu-arrow"></span>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="#">
                                        <span class="menu-icon-wrap">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <use xlink:href="#medical-report"></use>
                                            </svg>
                                        </span>
                                        <span class="menu-txt">Medical Record</span>
                                        <span class="arrow right menu-arrow"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="menu-txt">Blog & Articles</span>
                                        <span class="arrow right menu-arrow"></span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="logout-area">
                        <a class="logout" onclick="window.location.href='index.html'">Log out</a>
            ...
            <section class="container mission-statement landing-top-heading">
                <div class="mission-statement-detail">
                    <div class="statement">
                        ...
                        <h3>Aapki Sehat, Hamari Tarjeeh</h3>
                    </div>
                    <div class="detial">
                        <p>Healthwire is on a mission to make quality healthcare more accessible and affordable for 220
                            Million+ Pakistanis. We believe in empowering our users with the most accurate,
                    ...
                    <div class="top-specialties-inner">
                        <a href="#" class="top-specialties-block">
                            ...
                            <div class="icon-block">
                                <img src="https://healthwire-bucket.s3.eu-west-3.amazonaws.com/All-Specialties-Icon/Dentist.svg"
                        ...
                        <a href="#" class="top-specialties-block">
                            ...
                            <div class="icon-block">
                                <img src="https://healthwire-bucket.s3.eu-west-3.amazonaws.com/All-Specialties-Icon/Cardiologist.svg"
                                    alt="stethoscope image" width="90" height="90">
                            </div>
                            <p> </p>
                        </a>
                        <a href="#" class="top-specialties-block">
                            ...
                            <div class="icon-block">
                                <img src="https://healthwire-bucket.s3.eu-west-3.amazonaws.com/All-Specialties-Icon/General+Physician.svg"
                                    alt="stethoscope image" width="90" height="90">
                            </div>
                            <p> </p>
                        </a>
                        <a href="#" class="top-specialties-block">
                            ...
                            <div class="icon-block">
                                <img src="https://healthwire-bucket.s3.eu-west-3.amazonaws.com/All-Specialties-Icon/Allergy.svg"
                                    alt="stethoscope image" width="90" height="90">
                            </div>
                            <p> </p>
                        </a>
...
{{--            </section>--}}
                                ...
                                <figure>
                                    <a
                                        ...
                                        <img alt="" title="" width="376" height="217"
                                            loading="lazy"
                                            src="data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs="
                                            data-original="https://healthwire.pk/wp-content/uploads/2022/09/difference-between-physical-therapy-and-rehabilitation.jpg">
                                    </a>
                                </figure>
                                ...
                                <a href="#">
                                    <figure>
                                        <img alt="" title="" width="376" height="217"
                                            loading="lazy"
                                            src="data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs="
                                            data-original="https://healthwire.pk/wp-content/uploads/2022/09/how-to-stop-hiccups.jpg">
                                    </figure>
                                ...
                                <a href="#">
                                    <figure>
                                        <img alt="" title="" width="376" height="217"
                                            loading="lazy"
                                            src="data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs="
                                            data-original="https://healthwire.pk/wp-content/uploads/2022/09/homeopathy-vs-allopathy.jpg">
                                    </figure>
                                    <h6>Herbal Health</h6>
                    ...
                    <div class="healthwire-app-inner">
                        <figure class="app-figure-img">
                            <img alt="" title="" width="342" height="422" loading="lazy"
                                src="data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs="
                                data-original="/assets/b2c_design/common/footer_mobile.webp">

                        </figure>
                        <div class="healthwire-app-content">
                            <div class="cor-header">
                                <h3>Thousands of doctors. <span>One app.</span></h3>
                                <p>The Healthwire app is the quickest, easiest way to book and keep track of your
                                    appointments.</p>
                            </div>
                            <div class="send-app-link-area">
                                <h4>Send the link to download the app</h4>
                                <form action="https://healthwire.pk/send_app_link" accept-charset="UTF-8"
                            ...
                            <div class="app-store">
                                <ul>
                                    <li><a
                                            href="https://play.google.com/store/apps/details?id=com.healthwire.healthwire&amp;hl=en_US">
                                    ...
                                    <li><a href="https://apps.apple.com/pk/app/healthwire/id1460789804">
            ...
            <style>
                ...
                .info .info-wrapper .ringing-icon-cover {
                    padding-right: 6px
                }

                .info .info-wrapper .ringing-icon-cover [class^=icon] {
                    font-size: 12px
                }
            ...
            <footer>
                    ...
                    <div class="container">
                        <div class="footer-dark-top">
                            <div class="footer-about">
                                ...
                                <div class="footer-app-area">
                                    ...
                                    <ul>
                                        <li><a href="https://play.google.com/store/apps/details?id=com.healthwire.healthwire&amp;hl=en_US"
                                                target="_blank">
                                                <svg width="135" height="40" viewBox="0 0 135 40"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink">
                                                ...
                                                <svg width="136" height="40" viewBox="0 0 136 40"
                                                    ...
                                                    <defs>
                                                        <pattern id="pattern1"
                                                            patternContentUnits="objectBoundingBox" width="1"
                                                            height="1">
                                                            <use xlink:href="#image0_38_27488"
                                                                transform="scale(0.00367647 0.0125)" />
                                                        </pattern>
                                                        <image id="image0_38_27488" width="272" height="80"
                                                            xlink:href="data:image/png;base64," />
                                                    </defs>
                                                </svg>
                                            </a></li>
                            ...
                            <div class="footer-links">
                                ...
                                <div class="footer-cols">
                                    ...
                                    <ul>
                                        <li><a href="doctors/lahore/dermatologist.html">Dermatologist</a></li>
                                        <li><a href="doctors/lahore/gynecologist.html">Gynecologist</a></li>
                                        <li><a href="doctors/lahore/neurologist.html">Neurologist</a></li>
                                        <li><a href="doctors/lahore/gastroenterologist.html">Gastroenterologist</a>
                                        </li>
                                        <li><a href="doctors/lahore/orthopedic-surgeon.html">Orthopedic Surgeon</a>
                                        </li>
                                        <li><a href="doctors/lahore/dentist.html">Dentist</a></li>
                                        <li><a href="doctors/lahore/ophthalmologist.html">Ophthalmologist</a></li>
                                        <li><a href="doctors/lahore/psychiatrist.html">Psychiatrist</a></li>
                                        <li><a href="doctors/lahore/urologist.html">Urologist</a></li>
                                        <li><a href="doctors/lahore/ear-nose-throat-specialist.html">Ear, Nose, Throat
                                                Specialist</a></li>
                                    </ul>
                                </div>
                                <div class="footer-cols">
                                    <h6>Resources</h6>
                                    <ul>
                                        <li><a href="healthcare/index.html">Blogs</a></li>
                                        <li><a href="hospitals.html">Hospital</a></li>
                                        <li><a href="lab-tests.html">Labs</a></li>
                                        <li><a href="b2c_procedures.html">Procedures</a></li>
                                        <li><a href="pharmacy.html">Pharmacy</a></li>
                                        <li><a href="doctors.html">Doctors</a></li>
                                        <li><a href="corporate-wellness.html">Corporate Wellness</a></li>

                                    </ul>
                                </div>
                                <div class="footer-cols footer-col-contact">
                                    <h6>Contact</h6>
                                    <div class="tel"><span> Talk to support </span> <a href="tel:04232500989">042
                                            32500989</a></div>
                        ...
                        <div class="footer-dark-bot">
                            <div class="footer-copyright">
                                <ul>
                                    <li>© Healthwire 2022</li>
                                    <li><a class="show-loader" href="terms-and-conditions.html">Terms</a></li>
                                    <li><a class="show-loader" href="privacy.html">Privacy</a></li>
                                </ul>
                            </div>
                            <div class="footer-social-links">
                                <ul>
                                    <li><a href="https://www.youtube.com/channel/UC0JMiTeGKuecPy537crX2tQ">
                                    ...
                                    <li><a href="https://www.facebook.com/healthwire.pk">
                                    ...
                                    <li><a href="https://twitter.com/healthwirepk">
                                    ...
                                    <li><a href="https://www.linkedin.com/company/healthwirepk/">
                                            <svg width="18" height="18" viewBox="0 0 18 18"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <svg class="hide">
                    <defs>
                        <g id="my-account">
                            <path
                                d="M10.0003 11.1094C7.79091 11.1117 5.67266 11.9905 4.11037 13.5528C2.54807 15.115 1.66935 17.2333 1.66699 19.4427C1.66699 19.5901 1.72552 19.7314 1.82971 19.8355C1.9339 19.9397 2.07521 19.9983 2.22255 19.9983H17.7781C17.9254 19.9983 18.0668 19.9397 18.1709 19.8355C18.2751 19.7314 18.3337 19.5901 18.3337 19.4427C18.3313 17.2333 17.4526 15.115 15.8903 13.5528C14.328 11.9905 12.2097 11.1117 10.0003 11.1094Z"
                                fill="#A1A4A9" />
                            <path
                                d="M10.0004 10.5556C12.9153 10.5556 15.2782 8.19261 15.2782 5.27778C15.2782 2.36294 12.9153 0 10.0004 0C7.0856 0 4.72266 2.36294 4.72266 5.27778C4.72266 8.19261 7.0856 10.5556 10.0004 10.5556Z"
                                fill="#A1A4A9" />
                        </g>
                    </defs>
                </svg>
                ...
                <svg class="hide">
                    <defs>
                        <g id="andrologist_icon">
                            <path
                                d="M72 10.6667H69.3333C69.3333 4.784 64.5493 0 58.6667 0H21.3333C15.4507 0 10.6667 4.784 10.6667 10.6667V13.6024C4.58926 14.8429 0 20.2292 0 26.6667C0 34.0184 5.98156 40 13.3333 40H21.3333V64C21.3333 72.8238 28.5096 80 37.3333 80H64C72.8238 80 80 72.8238 80 64V18.6667C80 14.256 76.4107 10.6667 72 10.6667ZM13.3333 34.6667C8.92267 34.6667 5.33333 31.0773 5.33333 26.6667C5.33333 23.1762 7.59223 20.2345 10.7148 19.1441C10.9708 24.8 15.616 29.3333 21.3333 29.3333V34.6667H13.3333ZM74.6667 64C74.6667 69.8827 69.8827 74.6667 64 74.6667H37.3333C31.4507 74.6667 26.6667 69.8827 26.6667 64V18.6667C26.6667 17.1946 27.8643 16 29.3333 16H72C73.469 16 74.6667 17.1946 74.6667 18.6667V64Z"
                                fill="#163E73" />
                            <path
                                d="M69.3335 18.6672H32.0002C30.5281 18.6672 29.3335 19.8595 29.3335 21.3339V56.0006C29.3335 60.4112 32.9228 64.0006 37.3335 64.0006H64.0002C68.4108 64.0006 72.0002 60.4112 72.0002 56.0006V21.3339C72.0002 19.8595 70.8055 18.6672 69.3335 18.6672ZM66.6668 56.0006C66.6668 57.4726 65.4692 58.6672 64.0002 58.6672H37.3335C35.8645 58.6672 34.6668 57.4726 34.6668 56.0006V24.0006H66.6668V56.0006Z"
                                fill="#803E48" />
                            <path
                                d="M38.3467 66.8805C37.3598 66.4537 36.1866 66.6936 35.4402 67.4406C34.9604 67.9448 34.667 68.6406 34.667 69.3341C34.667 69.6805 34.7468 70.0276 34.8801 70.3472C35.0134 70.6675 35.2003 70.9579 35.4402 71.227C35.9467 71.7317 36.6134 72.0008 37.3337 72.0008C38.054 72.0008 38.7206 71.7317 39.2272 71.2276C39.4671 70.9585 39.654 70.6674 39.7873 70.3478C39.9206 70.0276 40.0004 69.6805 40.0004 69.3341C40.0004 68.6115 39.7069 67.9448 39.2272 67.4406C38.9605 67.2008 38.6671 67.0139 38.3468 66.8805H38.3467Z"
                                fill="#163E73" />
                            <path
                                d="M65.0128 66.8811C64.3729 66.612 63.6259 66.5876 62.986 66.8811C62.6657 67.0144 62.3729 67.2013 62.1062 67.4412C61.6265 67.9454 61.333 68.612 61.333 69.3347C61.333 69.6811 61.4128 70.0281 61.5461 70.3478C61.6794 70.668 61.8663 70.9585 62.1062 71.2275C62.6128 71.7323 63.2794 72.0013 63.9997 72.0013C64.72 72.0013 65.3866 71.7323 65.8932 71.2281C66.3997 70.7216 66.6664 70.0549 66.6664 69.3346C66.6664 68.6412 66.3729 67.9454 65.8932 67.4412C65.6265 67.2013 65.3331 67.0144 65.0128 66.881L65.0128 66.8811Z"
                                fill="#163E73" />
                            <path
                                d="M42.6667 34.667H58.6667C60.1387 34.667 61.3333 33.4747 61.3333 32.0003C61.3333 30.5259 60.1387 29.3336 58.6667 29.3336H42.6667C41.1946 29.3336 40 30.5259 40 32.0003C40 33.4747 41.1946 34.667 42.6667 34.667Z"
                                fill="#803E48" />
                            <path
                                d="M42.6667 45.3333H58.6667C60.1387 45.3333 61.3333 44.1411 61.3333 42.6667C61.3333 41.1923 60.1387 40 58.6667 40H42.6667C41.1946 40 40 41.1923 40 42.6667C40 44.1411 41.1946 45.3333 42.6667 45.3333Z"
                                fill="#803E48" />
                        </g>
                    </defs>
                </svg>
        ...
        <script>
            //<![CDATA[
            window.gon = {};
            gon.doctors_path = "/doctors";
            gon.hospitals_path = "/hospitals";
            gon.specialities_path = "/specialities";
            gon.searches_path = "/searches";
            gon.slots_path = "/slots";
            gon.diseases_path = "/diseases";
            gon.procedures_path = "/b2c_procedures";
            gon.news_index_path = "/news";
            gon.lab_tests_path = "/lab-tests";
            gon.lab_packages_path = "/lab-tests/health-profile";
            gon.doctor_female_missing_url = "assets/B2c/default-female-icon.svg";
            gon.doctor_male_missing_url = "assets/B2c/default-male-icon.svg";
            gon.doctor_missing_url = "assets/B2c/default-user-icon.svg";
            gon.default_contact_number = "04232500989";
            gon.practice_missing_url = "assets/hospital-img.svg";
            gon.praxis_home_page_path = "/for-doctors";
            gon.cursik_home_page_path = "/for-hospitals";
            gon.laboratory_page_path = "/for-laboratory";
            gon.pharmacy_page_path = "/for-pharmacy";
            gon.corporate_wellness_page_path = "/corporate-wellness";
            gon.google_api_key = "AIzaSyDQbejTh8LLyIWWXBe11AgdfpB5wwAfLBY";
            gon.one_signal_api = "931915bd-7c0e-43e6-afeb-88da00590593";
            gon.foree_api_key = "33cea170-3859-4d50-ba3b-4b63059fe7b4";
            gon.foree_response_url = "foree-status/index.html";
            gon.order_foree_response_url = null;
    ...
    <script src="../d2cyip4t2cqq7y.cloudfront.net/assets/javascripts/B2c/specific/navi_cart.min.js" defer="defer"></script>
    <script src="../d2cyip4t2cqq7y.cloudfront.net/assets/javascripts/B2c/global/common.min.js" defer="defer"></script>
    <script>
        var gtmTimer = 3000;
    ...
    <noscript>
        <iframe height='0' src='https://www.googletagmanager.com/ns.html?id=GTM-N6S5LN'
            style='display:none;visibility:hidden' width='0'></iframe>
    </noscript>

    <script>
        $(window).on('load', function() {
            $("#city_name, .city_name.typeahead").val('Lahore');
            $("#locality").val(
                "{\"_index\":\"\",\"_type\":\"area\",\"_id\":\"10\",\"_score\":null,\"_source\":{\"formatted_address\":\"Lahore, Punjab, Pakistan\",\"address\":\"Lahore, Punjab, Pakistan\",\"name\":\"Lahore\",\"area_type\":\"city\",\"slug\":\"lahore\",\"parents\":[{\"name\":\"Pakistan\",\"id\":2,\"area_type\":\"country\",\"slug\":\"pakistan\"},{\"name\":\"Punjab\",\"id\":4,\"area_type\":\"province\",\"slug\":\"punjab\"}]},\"sort\":[0]}"
                );
        });
        var windowsize = $(window).width();
        $('.input-action').click(function() {
            $('.search_bar_doc').focus();
        });

        $(document).ready(function() {
            var blood_hound_functions, typeahead_config;
            if (!($(".controller__b2c.action__landing").length > 0)) {
                return;
            }
            $('.no-timing-slots-availailable-check').prev().children('.actions').addClass(
                'no-timing-slots-available');
            ...
            $('.search_doctors.typeahead').typeahead(...typeahead_config.get_config(['specialities', 'doctors',
                'items', 'lab_tests', 'classifications', 'practices', 'diseases'
            ])).on('typeahead:selected', function(e, data) {
                $('.search_doctors').typeahead('val', data._source.name);
                return setTimeout((function() {
                    ...
                    switch (data._type) {
                        case 'speciality':
                            ...
                            city = locality._source.area_type === 'city' ? locality._source
                                .slug : ((ref = locality._source.parents.find(function(area) {
                                    return (area != null ? area.area_type :
                                        void 0) === 'city';
                        ...
                        case 'classification':
                            ...
                            redirect_url =
                            `${gon.procedures_path}/${city}/${data._source.slug}`;
                            break;
                        case 'test':
            ...
            // Use array to pass parameters to typeahead function using '...'
            $('.city_name.typeahead').typeahead(...typeahead_config.get_config(['areas'])).on('typeahead:selected',
                function(e, data) {
                    var theVal;
                    $('.locality').val(JSON.stringify(data));
                    $('.city_name').typeahead('val', data._source.name);
                    $('.call-now-btn').attr('href',
                        `tel:${normalize(data._source.phone_number || gon.default_contact_number)}`);
                    $('.contact-num').text(normalize(data._source.phone_number || gon.default_contact_number));
                    if ((data._source.parents[2] && data._source.parents[2].name == 'Karachi') || data._source
                        .slug == 'karachi') {
                        $(".contact-num").empty().append("021 37130261");
                    }
            ...
            return $(".search-focus").click(function() {
                ...
                locality = JSON.parse($('#locality').val());
                city = locality._source.area_type === 'city' ? locality._source.slug : ((ref = locality
                    ._source.parents.find(function(area) {
                ...
                if ($('#city_name').val() !== "" && $('#search_doctors').val() !== "" && (gon
                        .current_speciality != null)) {
        ...
        $(document).ready(function() {
            $(document).on('mouseenter', '.speciality .dropdown-row', function(event) {
                ...
                $('.search_doctors.search_bar_doc.typeahead.tt-query.tt-input.tt-hint').val(valued_text);
                $('.search_doctors.search_bar_doc.typeahead.tt-query.tt-input').val(valued_text);
            }).on('mouseleave', '.dropdown-row', function() {
                var stored_text;
                stored_text = $('.select-cover.speciality').find('pre').text();
                $('.search_doctors.search_bar_doc.typeahead.tt-query.tt-input.tt-hint').val(stored_text);
                return $('.search_doctors.search_bar_doc.typeahead.tt-query.tt-input').val(stored_text);
            });
            return;
    ...
    <script
        src="assets/twitter/typeahead/typeahead.bundle-2b4055765134cec40995327cbb6de1eee2d5fa357e900fa71745c46f820407ba.js"
        defer="defer"></script>
    <script src="assets/search-fcd5f803af655aa848036daf4a3256b6c389ba76106db5076b7be65baad47277.js" defer="defer"></script>
    <script src="assets/typehead_classification-b39724ae997eccc09047874119718f818e2b9ee7d92d93f9672ebc8e03ac303d.js"
        defer="defer"></script>
    <script>
        $(window).on('load', function() {
        ...
        $(document).ready(function() {
            ...
            blood_hound_functions = new BloodHoundFunctions(window);
            typeahead_config = new TypeaheadCofig(blood_hound_functions);
            search_priority = ["specialities", "doctors", "items", "lab_tests", "classifications", "practices",
                "diseases"
            ];
            // Use array to pass parameters to typeahead function using '...'
            $('.search_doctors_header.typeahead').typeahead(...typeahead_config.get_config(search_priority)).on(
                'typeahead:selected',
                function(e, data) {
            ...
            // Use array to pass parameters to typeahead function using '...'
            $('.city_name_header.typeahead').typeahead(...typeahead_config.get_config(['areas'])).on(
                'typeahead:selected',
                function(e, data) {
                    var theVal;
                    $('.locality').val(JSON.stringify(data));
            ...
            return $(".search-focus").click(function() {
                ...
                if ($('#city_name_header').val() !== "" && $('#search_doctors_header').val() !== "" && (gon
                        .current_speciality != null)) {
                    // User entered a speciality
                    path = `${path}/${gon.current_speciality}`;
                }
        ...
        $(document).ready(function() {
            $(document).on('mouseenter', '.speciality .dropdown-row', function(event) {
                var valued_text;
                valued_text = $(this).find(".drop-content-hd").text();
                $('.search_doctors_header.search_bar_doc_header.typeahead.tt-query.tt-input.tt-hint').val(
                    valued_text);
                $('.search_doctors_header.search_bar_doc_header.typeahead.tt-query.tt-input').val(
                    valued_text);
            }).on('mouseleave', '.dropdown-row', function() {
                var stored_text;
                stored_text = $('.select-cover.speciality').find('pre').text();
                $('.search_doctors_header.search_bar_doc_header.typeahead.tt-query.tt-input.tt-hint').val(
                    stored_text);
                return $('.search_doctors_header.search_bar_doc_header.typeahead.tt-query.tt-input').val(
                    stored_text);
            });
            return;
            $('.auto-submit').keypress(function(e) {
    ...
    <script>
        $(".user-img").click(function(event) {
            ...
            $(".main-header nav > ul > li").removeClass("active");
            $(".user-dropdown").toggle();
        });
        $(".main-header nav > ul > li").click(function(event) {
            event.stopPropagation();
            $(".user-dropdown").hide();
        ...
        $(document).click(function(e) {
            if ($(e.target).closest(".user-dropdown , .main-header nav > ul > li").length === 0) {
                $(".user-dropdown").hide();
                $(".main-header nav > ul > li").removeClass("active");
            };
        });
    ...
    <script src="../d2cyip4t2cqq7y.cloudfront.net/assets/jquery_gem_dependency.min.js" defer="defer"></script>
    <script>
        $(document).ready(function() {
            ...
            if (WindowWidth < 768) {
                $(".show-modal-mobile").click(function() {
                    ...
                    $(".search_doctors_header.all-search-section.search_bar_doc_header.typeahead.tt-query.tt-input.event-speciality-selection-doctor-search")
                        .focus()
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993"
        ...
        data-cf-beacon='{"rayId":"79154dc958a8ca7c","token":"9e472d7cfb9549f9b5ff4247fb9f10fc","version":"2022.11.3","si":100}'
